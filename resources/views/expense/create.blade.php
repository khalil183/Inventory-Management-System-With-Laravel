                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('expense.store') }}" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="expense_amount" name="expense_amount" aria-describedby="emailHelp" placeholder="Expense Amount" value="{{ old('expense_amount') }}" >
                                            </div>

                                            <div class="form-group">
                                                <label for="expense_details">Expense Details</label>
                                                <textarea name="expense_details" id="expense_details" cols="30" rows="5" class="form-control" placeholder="Type Somethings..">{{ old('expense_details') }}</textarea>
                                            </div>
