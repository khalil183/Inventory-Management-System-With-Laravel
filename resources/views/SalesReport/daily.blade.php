        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card card-statistics">
                    <div class="card-body">
                        <form action="{{ route('daily.sales.report-search') }}" method="post">
                            @csrf
            ...
            <div class="col-lg-12">
                <div class="card card-statistics">
                    <div class="card-body">
                        ...
                        @isset($date)
                            <h4 class="py-2 text-success">Sales Of  {{ $date }} : {{ $sell }} Tk</h4>

                            <h4 class="py-2 text-success">Profit Of  {{ $date }} : {{ $profit }} Tk</h4>
                        @else
