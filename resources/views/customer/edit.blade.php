                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  method="POST" action="{{ route('customer.update',$customer->id) }}" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Customer Name" value="{{ $customer->name }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="phone">Customer Phone</label>
                                                <input type="text" class="form-control" id="phone" name="phone" aria-describedby="emailHelp" placeholder="Customer Phone" value="{{ $customer->phone }}">
                                            </div>
